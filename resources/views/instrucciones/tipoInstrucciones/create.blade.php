    ...
    <div class="container mt-3">    
        <form autocomplete="off" id="form-general" method="POST" action="{{url('/instrucciones/tipo')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="nombre" class="ml-1 {{ ($errors->has('nombre')) ? 'text-danger' : '' }}">Nombre del Tipo de Instrucción</label>
            ...
            <div class="form-group">
                <label for="descripcion" class="ml-1 {{ ($errors->has('descripcion_tipo')) ? 'text-danger' : '' }}">Descripción</label>
