...
<div class="container mt-5">
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            <div class="container">
                <div class="container mt-4">
                    <h5 class="text-dark">Instrucciones de {{ $maquina->nombre_maquina }} &nbsp;<a href="{{ Request::root() }}/maquinas/instrucciones/create" class="btn btn-outline-success btn-sm"><i class="far fa-plus-square"></i> Agregar</a></h5>
                        ...
                        @foreach ($instrucciones as $instruccion)
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ Request::root() }}/maquinas/instrucciones/{{ $instruccion->id }}" class="btn btn-primary btn-sm">Ver más</a>
                                </div>
                            </div>
                        @endforeach
